...
number=int("+88017 nehi dunga")

devoloper_info={
    "Developer" :  'Tanvir pathan',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/CYBER-BD71',
    "Facebook" :  'facebook.com/TANVIR HOSSEIN.0fficial',
    }
...
note1="""- __Inbox__ Me for Join `Team CYBER-BD71`\n- Try tool and **Review**"""
n1=Markdown(note1)
